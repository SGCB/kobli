...
<xsl:stylesheet version="1.0"
 ...
 <xsl:attribute name="href">/cgi-bin/koha/opac-search.pl?q=Host-item:<xsl:value-of select="marc:controlfield[@tag=001]"/>+and+(bib-level:a+or+bib-level:b)</xsl:attribute>
 </xsl:when>
 <xsl:otherwise>
 ...
 <xsl:choose>
 <xsl:when test="$typeOf008='Mon'"><img alt="Libro" src="/intranet-tmpl/prog/img/famfamfam/BK.png" title="Libro" /> Libro</xsl:when>
 <xsl:when test="$typeOf008='Per'"><img alt="Periódica" src="/intranet-tmpl/prog/img/famfamfam/AR.png" title="Periódica" /> Periódica</xsl:when>
