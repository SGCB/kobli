...
<xsl:stylesheet version="1.0" 
 ...
 <xsl:when test="marc:subfield[@code='4']='075'">, autor del epílogo</xsl:when>
 <xsl:when test="marc:subfield[@code='4']='080'">, autor del prefacio</xsl:when>
 ...
 <xsl:when test="marc:subfield[@code='4']='212'">, comentarista</xsl:when>
 <xsl:when test="marc:subfield[@code='4']='220'">, compilador</xsl:when>
 <xsl:when test="marc:subfield[@code='4']='230'">, compositor</xsl:when>
 <xsl:when test="marc:subfield[@code='4']='245'">, diseñador</xsl:when>
 <xsl:when test="marc:subfield[@code='4']='295'">, otorgante de grado</xsl:when>
 <xsl:when test="marc:subfield[@code='4']='340'">, editor</xsl:when>
 <xsl:when test="marc:subfield[@code='4']='370'">, editor de la película</xsl:when>
 <xsl:when test="marc:subfield[@code='4']='395'">, fundador</xsl:when>
 <xsl:when test="marc:subfield[@code='4']='440'">, ilustrador</xsl:when>
 <xsl:when test="marc:subfield[@code='4']='520'">, letrista</xsl:when>
 <xsl:when test="marc:subfield[@code='4']='557'">, organizador de congreso</xsl:when>
 <xsl:when test="marc:subfield[@code='4']='570'">, otro</xsl:when>
 <xsl:when test="marc:subfield[@code='4']='600'">, fotógrafo</xsl:when>
 <xsl:when test="marc:subfield[@code='4']='605'">, presentador</xsl:when>
 <xsl:when test="marc:subfield[@code='4']='650'">, editor</xsl:when>
 <xsl:when test="marc:subfield[@code='4']='651'">, director de publicación</xsl:when>
 <xsl:when test="marc:subfield[@code='4']='673'">, jefe del equipo de investigación</xsl:when>
 ...
 <xsl:when test="marc:subfield[@code='4']='727'">, director de tesis</xsl:when>
 <xsl:when test="marc:subfield[@code='4']='730'">, traductor</xsl:when>
 </xsl:choose>
 </dc:creator>
 </xsl:for-each>
 <dc:type>
 ...
 <xsl:choose>
 <xsl:when test="marc:subfield[@code='c']='MAIN'">Biblioteca principal</xsl:when>
 <xsl:when test="marc:subfield[@code='c']='BIB2'">Biblioteca 2</xsl:when>
 </xsl:choose>
