...
('dateformat','iso','metric|us|iso','Define global date format (us mm/dd/yyyy, metric dd/mm/yyy, ISO yyyy-mm-dd)','Choice'),
...
('EasyAnalyticalRecords','1','','If on, display in the catalogue screens tools to easily setup analytical record relationships','YesNo'),
...
('OpacBrowser',1,'If ON, enables subject authorities browser on OPAC (needs to set misc/cronjob/sbuild_browser_and_cloud.pl)',NULL,'YesNo'),
('OpacBrowseResults','1',NULL,'Disable/enable browsing and paging search results from the OPAC detail page.','YesNo'),
('OpacCloud',0,'Si ON, habilita nube de temas en el OPAC',NULL,'YesNo'),
...
('opaclanguages','en,es-ES','Set the default language in the OPAC.',NULL,'Languages'),
