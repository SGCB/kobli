...
>>>>>>> Base de datos espanyol II:installer/data/mysql/sysprefs.sql
...
INSERT INTO `systempreferences`(`variable`,`value`,`options`,`explanation`,`type`) VALUES ('LibraryName','Biblioteca de la AGE','','Define the library name as displayed on the OPAC','');
...
INSERT INTO `systempreferences`(`variable`,`value`,`options`,`explanation`,`type`) VALUES ('OpacMainUserBlock','<h1>Proyecto Kobli</h1>KOBLI es un sistema integrado de gesti&oacute;n de bibliotecas (SIGB) de fuentes abiertas desarrollado por el impulso del Grupo de Trabajo de las BAGEs (Bibliotecas de la Administraci&oacute;n General del Estado) que realiz&oacute; un estudio y evaluaci&oacute;n de las soluciones SIGB de c&oacute;digo abierto disponibles que sirviese como base para la distribuci&oacute;n propia de un SIGB para las BAGEs interesadas y para cualquier otra biblioteca. \nSe eligi&oacute; KOHA por ser el SIGB m&aacute;s avanzado que cubre la mayor&iacute;a de las funcionalidades requeridas. \nKOBLI es el resultado de a&ntilde;adir a KOHA las funcionalidades y mejoras sugeridas por el Grupo de Trabajo, adem&aacute;s se  trabajar&aacute; sobre las necesidades de koha-comunity.org, as&iacute; como las peticiones y  sugerencias manifestadas durante en el proceso de implantaci&oacute;n de KOBLI.\n<br><br>M&aacute;s informaci&oacute;n en:&nbsp; <a href=\"http://www.kobli.belrios.de/wordpress%20\">www.kobli.belrios.de/wordpress\n</a>\n','70|10','A user-defined block of HTML  in the main content area of the opac main page','Textarea');
...
INSERT INTO `systempreferences` (variable,value,explanation,options,type) VALUES('opaclanguages','en,es-ES','Set the default language in the OPAC.',NULL,'Languages');
INSERT INTO `systempreferences` (variable,value,explanation,options,type) VALUES('opaclanguagesdisplay',1,'If ON, enables display of Change Language feature on OPAC','','YesNo');
...
INSERT INTO `systempreferences` (variable,value,explanation,options,type) VALUES('gist','0.4','Default Goods and Services tax rate NOT in %, but in numeric form (0.12 for 12%), set to 0 to disable GST','','Integer');
...
INSERT INTO `systempreferences` (variable,value,explanation,options,type) VALUES('language','en,es-ES','Set the default language in the staff client.',NULL,'Languages');
...
INSERT INTO `systempreferences` (variable,value,explanation,options,type) VALUES('GoogleJackets','1','if ON, displays jacket covers from Google Books API',NULL,'YesNo');
...
INSERT INTO `systempreferences` (variable,value,explanation,options,type) VALUES('AutoEmailOpacUser','1','Sends notification emails containing new account details to patrons - when account is created.',NULL,'YesNo');
